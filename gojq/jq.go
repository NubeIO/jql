...
// QueryToArray queries against the JSON with the expression passed in, and convert to a array: []any
...
// QueryToString queries against the JSON with the expression passed in, and convert to string
...
// QueryToInt64 queries against the JSON with the expression passed in, and convert to int64
...
// QueryToFloat64 queries against the JSON with the expression passed in, and convert to float64
